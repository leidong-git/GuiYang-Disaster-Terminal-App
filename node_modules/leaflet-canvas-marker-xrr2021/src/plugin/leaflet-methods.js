!function (t) {
    ...
    e.prototype = {
        all: function () {
            ...
            for (_(t, n, i, f, this.compareMinX), h = n; h <= i; h += f) for (_(t, h, c = Math.min(h + f - 1, i), m, this.compareMinY), l = h; l <= c; l += m) u = Math.min(l + m - 1, c), e.children.push(this._build(t, l, u, a - 1));
            ...
            var r = this._chooseSplitIndex(i, e, a), s = p(i.children.splice(r, i.children.length - r));
        ...
        var n = (t.Layer ? t.Layer : t.Class).extend({
            initialize: function (n) {
                ...
                if(this._latlngMarkers) {
                    this._latlngMarkers.data = {}
                    this._latlngMarkers.total = 0
                    this._latlngMarkers.dirty = t.length
                    this._redraw(!0)
                }
            }

		...
		e.prototype = {
			...
			_chooseSplitIndex: function(t, n, i) {
				...
				for (l = c = 1 / 0, a = n; a <= i - n; a++) e = s(t, 0, a, this.toBBox), r = s(t, a, i, this
					...
					.minX), p = Math.max(f.minY, d.minY), x = Math.min(f.maxX, d.maxX), g = Math.min(f.maxY,
						d.maxY), o = Math.max(0, x - _) * Math.max(0, g - p), h = m(e) + m(r), o < l ? (l =
		...
		t.exports = function(t) {
			var n = (t.Layer ? t.Layer : t.Class).extend({
				...
				onAdd: function(t) {
					this._map = t, this._canvas || this._initCanvas(), this.options.pane ? this
						.getPane().appendChild(this._canvas) : t._panes.overlayPane.appendChild(this
							._canvas), t.on("move", this._reset, this), t.on("moveend", this._reset,
							this), t.on("resize", this._reset, this), t.on("click", this
							._executeListeners, this), t.on("mousemove", this._executeListeners,
				...
				onRemove: function(t) {
					this.options.pane ? this.getPane().removeChild(this._canvas) : t.getPanes()
						.overlayPane.removeChild(this._canvas), t.off("click", this
							...
							this), t.off("move", this._reset, this), t.off("moveend", this._reset,
							this), t.off("resize", this._reset, this), t._zoomAnimated && t.off(
				...
				_drawMarker: function(t, n) {
					...
					if (t.canvas_img) i._drawImage(t, n), i._drawText(t, n);
				...
				_drawImage: function(t, n) {
					...
					if (typeof(i.iconCanvas) != "undefined") {
						;
						t.canvas_img = i.iconCanvas;
					};
				...
				_drawText: function(t, n) {
					var i = t.options.icon.options;
					i.text && (this._context.strokeStyle = i.strokeStyle, this._context.font = i
						.textFont, this._context.fillStyle = i.textFillStyle, this._context
						.fillText(i.text, n.x - i.textAnchor[0], n.y - i.textAnchor[1]))
				},
				_reset: function() {
